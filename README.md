...
## Описание проекта
Полноценный Data Engineering проект (End-to-End). Пайплайн эмулирует поток данных о покупках в магазине видеоигр, обрабатывает их и предоставляет доступ для аналитики.
